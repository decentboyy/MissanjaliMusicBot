...
async def update(_, message: Message):
    ...
    if str(m[0]) != "A":
        ...
        await message.reply_text("Bot is already in the **up-to-date** mode with **[latest version](https://graph.org/file/afea72d2fc5233e686b75.mp4)**", disable_web_page_preview=True)
